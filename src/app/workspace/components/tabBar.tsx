export default function TabBar({ setIsAddTask }: { setIsAddTask: Function }) {
  return (
    <div className="fixed grid grid-cols-5 items-center border-t-2 border-black border-opacity-60 -bottom-0 w-full p-2 bg-white z-50">
      ...
      <div
        className="bg-[#F26E56] p-3 w-2/3 mx-auto rounded-full flex items-center justify-center"
